  ...
  private class MetadataTreeListener implements TreeSelectionListener {
    ...
    private class MetaObjectAddButtonListener implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (mMetaObject instanceof MResource) {
          ...
          } else if (mAnswer.equals("EditMask")) {
            boolean found = false;
            /*
          ...
          } else if (mAnswer.equals("SearchHelp")) {
            boolean found = false;
            /*
          ...
          } else if (mAnswer.equals("UpdatehHelp")) {
            boolean found = false;
            /*
          ...
          } else if (mAnswer.equals("ValidationLookup")) {
            boolean found = false;
            /*
          ...
          } else if (mAnswer.equals("ValidationExternal")) {
            boolean found = false;
            /*
          ...
          } else if (mAnswer.equals("ValidationExpression")) {
            boolean found = false;
            /*
        ...
        } else if (mMetaObject instanceof MClass) {
          /*
        ...
        if (mMetaObject instanceof MetaObject) {
          ...
          if (answer == JOptionPane.OK_OPTION) {
            ...
            if (parentObject instanceof MetaObject) {
              ...
              else if (parentObject.equals(sFOREIGNKEY))
    ...
    private class MetaObjectEditButtonListener implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        } else if (mMetaObject instanceof MResource) {
          /*
           * Invoke the custom dialog.
           */
