 ...
 *
 * @author mklein
 * @hibernate.mapping package="org.realtors.rets.server"
 * @hibernate.class table="rets_media"
 */
public class Media implements Serializable, Comparable {
   ...
   * @hibernate.composite-id class="org.realtors.rets.server.MediaKey"
   */
   ...
   * @hibernate.property column="resource_file_path"
   * not-null="true"
   */
   ...
   * @hibernate.property column="modification_timestamp"
   * type="timestamp"
   */
