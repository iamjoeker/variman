...
public class ResourceBasedActivationManagerTest {
  ...
  private ActivationStrategy createStrategy(final boolean valid, final String host,
    ...
    context.checking(new Expectations() {{
      allowing(activationStrategy).isCodeValid(host, email, code);
  ...
  private Resource createResource(final boolean exists, String email, String code) throws Exception {
    ...
    context.checking(new Expectations() {{
      allowing(activationResource).exists();
      will(returnValue(exists));
      allowing(activationResource).getDescription();
      will(returnValue("Mock Resource"));
    ...
    if (email != null && code != null) {
      ...
      context.checking(new Expectations() {{
        allowing(activationResource).getInputStream();
        will(returnValue(
